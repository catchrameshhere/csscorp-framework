...
public class TestExample {
    ...
    public void setUp() throws IOException {
		 ...
		 * caps.setCapability("app", APP); caps.setCapability("appActivity",
		 * ".graphics.FingerPaint"); caps.setCapability("automationName",
		 * "UiAutomator2"); driver = new AndroidDriver(new
		 * URL("http://localhost:4723/wd/hub"), caps);
		 */
    	
    	DesiredCapabilities caps = new DesiredCapabilities();
        caps.setCapability("platformName", "Android");
        caps.setCapability("deviceName", "ce7b260f");
